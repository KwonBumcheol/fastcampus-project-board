...
class ArticleServiceTest {
    ...
    @Mock private ArticleRepository articleRepository; // 가짜 객체(Mock)을 만들어 테스트 -> DB를 접근하지 않고 동작 시뮬레이션 가능
    ...
    @Test
    void givenNonexistentArticleId_whenSearchingAricle_thenThrowsException() {
        // Given 준비
        Long articleId = 0L;
